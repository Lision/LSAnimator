...
//
//  source https://github.com/jhurray/JHChainableAnimations
...
@implementation LSKeyframeAnimation
...
- (id)copyWithZone:(nullable NSZone *)zone {
    LSKeyframeAnimation *copy = [[LSKeyframeAnimation allocWithZone:zone] init];
