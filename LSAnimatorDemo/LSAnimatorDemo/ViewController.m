...
//        _animatorView.ls_cornerRadius(0).ls_bounds(CGRectMake(0, 0, 20, 20)).ls_center(self.view.center.x, self.view.center.y - 20).ls_animate(0.5);
...
//    layer 动画执行 的时候 也执行了隐式动画
    ...
    _layer.ls_concurrent.ls_background([UIColor orangeColor]).ls_delay(0.75).ls_animate(1);
